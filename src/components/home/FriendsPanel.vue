...
// Friend row enter/leave/reorder (added/removed friends, status changes)
.friend-row-pop-enter-active,
.friend-row-pop-leave-active {
  transition: opacity 180ms ease, transform 180ms cubic-bezier(0.25, 1, 0.5, 1);
}
.friend-row-pop-move { transition: transform 220ms cubic-bezier(0.25, 1, 0.5, 1); }
.friend-row-pop-enter-from { opacity: 0; transform: scale(0.96) translateY(-6px); }
.friend-row-pop-leave-to   { opacity: 0; transform: scale(0.96); }
</style>
