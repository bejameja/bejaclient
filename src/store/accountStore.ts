...
export const useAccountStore = defineStore('account', () => {
  ...
  // Picks up tokens the main process refreshed in the background (see
  // authService's auto-refresh timer) without needing a manual reload.
  window.api.auth.onAccountsUpdated((updated) => {
    accounts.value = updated as Account[]
  })
